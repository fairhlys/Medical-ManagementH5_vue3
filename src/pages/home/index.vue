...
<template>
    ...
    <van-swipe class="my-swiper" height="170" :autoplay="3000" indicator-color="white">
      <van-swipe-item v-for="value in homeData.slides" :key="value.id">
        <van-image radius="5" :src="value.pic_image_url" />
      </van-swipe-item>
    </van-swipe>
    <van-row justify="space-around">
      <van-col span="11" v-for="(item,index) in homeData.nav2s" :key="item.id" class="center-img" @click="goOrderTwo(index)">
